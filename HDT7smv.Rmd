...
## comparacion
El mejor modelo fue el modelo 4 kernel lineal, que tiene un accuracy de 0.9499. a comparación del Random Forest que poseía un accuracy del 0.72, el algoritmo de bayes mostró 0.467 y el arbol de decisión (este falta Andreé no lo encontré)
